...
const warmPrismTheme: PrismTheme = {
  ...
  styles: [
    ...
    { types: ['variable', 'parameter'], style: { color: 'var(--color-code-parameter)' } },
    ...
    { types: ['inserted'], style: { color: 'var(--color-success)' } },
    { types: ['deleted'], style: { color: 'var(--color-error)' } },
  ],
}
...
const warmShikiTheme = {
  ...
  tokenColors: [
    ...
    { scope: ['markup.inserted', 'punctuation.definition.inserted'], settings: { foreground: 'var(--color-success)' } },
    { scope: ['markup.deleted', 'punctuation.definition.deleted'], settings: { foreground: 'var(--color-error)' } },
